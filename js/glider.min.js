...
!(function (e) {
	...
	return (
		...
		(t.updateControls = function (e) {
			...
			d.opt.rewind ||
				(d.arrows.prev && d.arrows.prev.classList.toggle("disabled", d.ele.scrollLeft <= 0 || t),
				d.arrows.next &&
					d.arrows.next.classList.toggle(
						"disabled",
						Math.ceil(d.ele.scrollLeft + d.containerWidth) >= Math.floor(d.trackWidth) || t
					)),
				...
				[].forEach.call(d.slides, function (e, t) {
					...
					[].forEach.call(o, function (e) {
						...
						c === t || (h && h === t)
							? o.add("center")
							: (o.remove("center"),
							  o.add([t < c ? "left" : "right", Math.abs(t - (t < c ? c : h || c))].join("-")));
					...
					(d.scrollLock = setTimeout(function () {
						clearTimeout(d.scrollLock),
							0.02 < Math.abs(d.ele.scrollLeft / d.itemWidth - d.slide) &&
								(d.mouseDown || d.scrollItem(d.round(d.ele.scrollLeft / d.itemWidth)));
		...
		(t.scrollItem = function (e, t, o) {
			...
			if ((++i.animate_id, !0 === t))
				...
				if ("string" == typeof e) {
					...
					if (
						...
						e =
							s && !l ? i.slides.length : !s && l + i.containerWidth >= Math.floor(i.trackWidth) ? 0 : e;
					}
				}
			...
			return (
				i.scrollTo(e, i.opt.duration * Math.abs(i.ele.scrollLeft - e), function () {
					i.updateControls(),
						i.emit("animated", { value: r, type: "string" == typeof r ? "arrow" : t ? "dot" : "slide" });
				}),
				!1
			);
		}),
				...
				for (var o = 0; o < t.length; ++o) {
					...
					if (a.innerWidth >= i.breakpoint)
						return (
							...
							((e.opt = Object.assign({}, e._opt, i.settings)), (e.breakpoint = i.breakpoint), !0)
						);
				}
			}
		...
		(t.scrollTo = function (t, o, i) {
			var r = this,
				...
				n = function () {
					...
					(r.ele.scrollLeft = r.ele.scrollLeft + (t - r.ele.scrollLeft) * r.opt.easing(0, e, 0, 1, o)),
						e < o && l === r.animate_id
